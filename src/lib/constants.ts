...
export const KEYBOARD_LAYOUT: KeyData[][] = [
  ...
  [
    ...
    { code: "ArrowDown", en: "", enShift: "", km: "", kmShift: "", label: "", type: "action", icon: "ChevronDown", width: 1 },
    { code: "ArrowUp", en: "", enShift: "", km: "", kmShift: "", label: "", type: "action", icon: "ChevronUp", width: 1 },
